...
@interface MyCollectionViewController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
- (void)viewDidLoad
{
    ...
    NSArray *array = @[@"moneyCell",@"kindCell",@"dateCell",@"locationCell",@"notebodyCell",@"photoCell",@"deleteCell",@"colorCell",@"inputcolorCell"];
...
-(void)registerNotifications
{
    ...
    [center addObserver:self
               selector:@selector(handleDeleteBillImageNotification:)
                   name:kDeleteBillImageNotification
                 object:nil];
...
-(void)configBarButtonItem
{
    ...
    UIColor *titleColor = self.navigationController.navigationBar.tintColor;
...
- (IBAction)done:(UIBarButtonItem *)sender
{
    ...
    if (self.bill.money.floatValue != 0) {
        ...
        MoneyCollectionViewCell *moneyCollectionViewCell = (MoneyCollectionViewCell *)cell;
