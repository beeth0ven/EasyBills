...
@interface BillCoreDataTableViewController ()

@end

@implementation BillCoreDataTableViewController
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    switch (self.isIncomeMode) {
        case isIncomeYes:
            self.navigationController.navigationBar.barTintColor = PNGreen;
            break;
        case isIncomeNo:
            self.navigationController.navigationBar.barTintColor = PNRed;
            break;
        default:
...
-(void)configCell:(BillTableViewCell *)cell WithBill:(Bill *)bill
{
    ...
    if ([sender isKindOfClass:[UITableViewCell class] ]) {
        if ([segue.identifier isEqualToString:@"showBill"]) {
            if ([segue.destinationViewController isKindOfClass:[UINavigationController class]]) {
                ...
                if ([navigationController.topViewController isKindOfClass:[MyCollectionViewController class]]) {
                    MyCollectionViewController *myCollectionViewController = (MyCollectionViewController *)navigationController.topViewController;
