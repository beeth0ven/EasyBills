//
//  CoreDataMapViewController.h
//  EasyBills
//
//  Created by 罗 杰 on 10/31/14.
...
@interface CoreDataMapViewController : UIViewController <NSFetchedResultsControllerDelegate,MKMapViewDelegate>
